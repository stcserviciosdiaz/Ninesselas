...
export class FiguracionComponent implements OnInit {
  ...
  registrarFotos(idUser) {
    ...
    for (let i = 0; i < filesAmount; i++) {
      let urlManos = 'figuracion/' + dni + '/manos-' + this.manosFileList[i].name;
  ...
  registrarActor() {
    ...
    if (this.fileAvatar === null || this.fileCuerpoEntero === null || this.manosFileList === null) {
  ...
  subirArchivos() {
    ...
    if (this.fileDNIB != null) {
      /**subir dni lado frontal */
      this.urlUsuarioB = 'figuracion/' + idUser + '/dnia-' + this.fileDNIB.name;
      task = this.storage.upload(this.urlUsuarioB, this.fileDNIB);
    }

    if (this.fileSeguroSocial != null) {
      /**subir dni lado frontal */
      this.urlSeguroSocial = 'figuracion/' + idUser + '/dnia-' + this.fileSeguroSocial.name;
    ...
    if (this.motosFileList != null) {
      ...
      for (let i = 0; i < filesAmount; i++) {
        let urlMoto = 'figuracion/' + idUser + '/moto-' + this.motosFileList[i].name;
    ...
    if (this.tatuajeFileList != null) {
      ...
      for (let i = 0; i < filesAmount; i++) {
        let urlTatuajes = 'figuracion/' + idUser + '/tatuajes-' + this.tatuajeFileList[i].name;
    ...
    if (this.manosFileList != null) {
      ...
      for (let i = 0; i < filesAmount; i++) {
        let urlManos = 'figuracion/' + idUser + '/manos-' + this.manosFileList[i].name;
