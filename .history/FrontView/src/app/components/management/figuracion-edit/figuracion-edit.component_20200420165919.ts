...
export class FiguracionEditComponent implements OnInit {
  ...
  confirmDeleteMoto(index: any) {
    ...
    this.idDeleteMoto = this.listCoches[index].idCoche;
  }

  deleteMotoPage(index: any) {
    if (this.idDeleteMoto !== 'undefined') {
  ...
  deleteCochePage() {
    if (this.idDeleteCoche !== 'undefined') {
  ...
  deleteTatuajePage(index: any) {
    if (this.idDeleteTatuaje !== 'undefined') {
    ...
    this.listTatuajes.splice(index, 1);
  }
  ...
  deleteManoPage(index: any) {
    if (this.idDeleteManos !== 'undefined') {
      this.authService.deleteCoche(this.idDeleteManos)
        .subscribe(resp => {
        });
    }
    this.urlsManos.splice(index, 1);
    this.manosFileList.splice(index, 1);
    this.listManos.splice(index, 1);
  }
